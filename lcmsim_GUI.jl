# Next steps:
# - Add advanced settings: i_model, timestep_factor
# - Add settings for all patches: porosity1,p1
...
par_0=GtkEntry(); set_gtk_property!(par_0,:text,"1")
...
g[1,12] = par_0; g[2,12] = p0_1; g[3,12] = p1_1; g[4,12] = p2_1; g[5,12] = p3_1; g[6,12] = p4_1; 
g[1,13] = par_1; g[2,13] = p0_2; g[3,13] = p1_2; g[4,13] = p2_2; g[5,13] = p3_2; g[6,13] = p4_2; 
g[1,14] = par_2; g[2,14] = p0_3; g[3,14] = p1_3; g[4,14] = p2_3; g[5,14] = p3_3; g[6,14] = p4_3; 
g[1,15] = par_3; g[2,15] = p0_4; g[3,15] = p1_4; g[4,15] = p2_4; g[5,15] = p3_4; g[6,15] = p4_4; 
g[1,16] = par_4; g[2,16] = p0_5; g[3,16] = p1_5; g[4,16] = p2_5; g[5,16] = p3_5; g[6,16] = p4_5; 
g[1,17] = par_5; g[2,17] = p0_6; g[3,17] = p1_6; g[4,17] = p2_6; g[5,17] = p3_6; g[6,17] = p4_6;      g[9,17] = h; 
                 g[2,18] = p0_7; g[3,18] = p1_7; g[4,18] = p2_7; g[5,18] = p3_7; g[6,18] = p4_7;      g[9,18] = q; 
                 g[2,19] = p0_8; g[3,19] = p1_8; g[4,19] = p2_8; g[5,19] = p3_8; g[6,19] = p4_8; 
                 g[2,20] = p0_9; g[3,20] = p1_9; g[4,20] = p2_9; g[5,20] = p3_9; g[6,20] = p4_9; 
push!(win, g)
...
function pm_clicked(w)
    ...
    lcmsim.plot_mesh(str,1)
end
function ps_clicked(w)
    str = get_gtk_property(mf,:text,String)
    lcmsim.plot_sets(str)
end
function sel_clicked(w)
    str = get_gtk_property(mf,:text,String)
    lcmsim.plot_mesh(str,2)
end
function ss_clicked(w)
    ...
    lcmsim.lcmsim_solver(modelval,str1,parse(Float64,str2), 1.01325e5,1.225,1.4,parse(Float64,str3), parse(Float64,str4),parse(Float64,str5),parse(Float64,str6),parse(Float64,str7), 
    parse(Float64,str11),parse(Float64,str12),parse(Float64,str13),parse(Float64,str14),parse(Float64,str15),parse(Float64,str16),parse(Float64,str17),parse(Float64,str18),parse(Float64,str19),
    parse(Float64,str21),parse(Float64,str22),parse(Float64,str23),parse(Float64,str24),parse(Float64,str25),parse(Float64,str26),parse(Float64,str27),parse(Float64,str28),parse(Float64,str29),
    parse(Float64,str31),parse(Float64,str32),parse(Float64,str33),parse(Float64,str34),parse(Float64,str35),parse(Float64,str36),parse(Float64,str37),parse(Float64,str38),parse(Float64,str39),
    parse(Float64,str41),parse(Float64,str42),parse(Float64,str43),parse(Float64,str44),parse(Float64,str45),parse(Float64,str46),parse(Float64,str47),parse(Float64,str48),parse(Float64,str49),
    parse(Float64,str51),parse(Float64,str52),parse(Float64,str53),parse(Float64,str54),parse(Float64,str55),parse(Float64,str56),parse(Float64,str57),parse(Float64,str58),parse(Float64,str59),
...
function pr_clicked(w)
    ...
    lcmsim.plot_results(str) 
end
function po_clicked(w)
    lcmsim.plot_overview(-1,16) 
end
